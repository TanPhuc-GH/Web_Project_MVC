    ...
    <div class="cart-content">
      <div class="cart-list-wrapper">
        <div class="cart_operator-bar">
          ...
          <a href="#" class="delete-all">Xóa dịch vụ đã chọn</a>
        </div>
        <div class="cart_list">
            ...
            <div class="cart_item">
              <div class="cart_item-content">
                <div class="checkbox-grid-item">
                  <label class="cart-list__node" for="${userBookTourInfor.userBookTourId}">
                    <div class="">
                      <i class="fa-solid fa-check input__check-icon"></i>
                    </div>
                    <input type="checkbox" checked name="checkTour" value ="${userBookTourInfor.userBookTourId}" id="${userBookTourInfor.userBookTourId}" class="appearance-none h-4 w-4 border border-gray-300 hover:border-orange rounded-sm bg-white checked:bg-orange
              ...
              <div class="cart_item-footer">
                <div class="footer-operator">
                  <a href="#" class="delete-item" id="${userBookTourInfor.userBookTourId}">Xóa</a>
                </div>
                <div class="footer-price">₫ <span class="item-price">${userBookTourInfor.getTourPricetoString()}</span></div>
              </div>
            </div>
