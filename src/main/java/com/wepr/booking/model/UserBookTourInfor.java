...
public class UserBookTourInfor {
    ...
    private String tourPricetoString;

    public String getTourPricetoString() {
        return tourPricetoString;
    }

    public void setTourPricetoString(String tourPricetoString) {
        this.tourPricetoString = tourPricetoString;
    }
}
