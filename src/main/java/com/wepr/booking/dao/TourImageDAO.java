...
public class TourImageDAO {
    public List<Tour_Image> getImages(int tourId){
        ...
        try{
            ...
            em.close();
            System.out.println("Closed connection TourImagesDAO with GetImages(tourId) method");
        }
    ...
    public Optional<Tour_Image> getImage(int tourId){
        ...
        try{
            ...
            em.close();
            System.out.println("Closed connection TourImagesDAO with GetImage(tourId) method");
        }
